...
public class FournisseurServiceImpl implements FournisseurService {
	...
	public FournisseurDto addFournisseur(FournisseurDto fournisseurDto) {
		...
		if (fournisseurDto.getUuidPaysProvenance() != null && !fournisseurDto.getUuidPaysProvenance().isEmpty()) {
			Pays pays = paysRepository.findById(fournisseurDto.getUuidPaysProvenance())
				.orElseThrow(() -> new RuntimeException("Pays de provenance non trouvé"));
			fournisseur.setPaysProvenance(pays);
		}
