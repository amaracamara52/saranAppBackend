...
public class DetailCommandeFournisseurServiceImpl implements DetailCommandeFournisseurService {
	...
	@Override
	public DetailCommandeFournisseurDto addDetailCommandeFournisseur(
			DetailCommandeFournisseurDto detailCommandeFournisseurDto) {
		...
		CommandeFournisseur commandeFournisseur = commandeFournisseurRepository
				.findById(detailCommandeFournisseurDto.getUuidCommandeFournisseur()).orElseThrow(null);
		Boutique boutique = boutiqueRepository.findById(detailCommandeFournisseurDto.getUuidBoutique())
				.orElseThrow(null);
		Utilisateur utilisateur = utilisateurRepository.findByEmail(auth.getName()).orElseThrow(null);
		Article article = articleRepository.findById(detailCommandeFournisseurDto.getUuidArticle()).orElseThrow(null);

		detailCommandeFournisseur.setArticle(article);
		detailCommandeFournisseur.setQuantite(detailCommandeFournisseur.getQuantite());
		detailCommandeFournisseur.setPrixAchat(detailCommandeFournisseur.getPrixAchat());
	...
	public void deleteDetailCommandeFournisseur(String uuid) {
		// TODO Auto-generated method stub
		DetailCommandeFournisseur detailCommandeFournisseur = detailCommandeFournisseurRepository.findById(uuid)
				.orElseThrow(null);
	...
	public List<DetailCommandeFournisseurDto> findAll() {
		...
		detailCommandeFournisseurs.forEach(detailCommandeFournisseur -> detailCommandeFournisseurDtos
				.add(Mapper.toDetailCommandeFournisseurDto(detailCommandeFournisseur)));
	...
	@Override
	public DetailCommandeFournisseurDto updateDetailCommandeFournisseur(
			DetailCommandeFournisseurDto detailCommandeFournisseurDto, String uuid) {
		// TODO Auto-generated method stub
		Authentication auth = SecurityContextHolder.getContext().getAuthentication();
		CommandeFournisseur commandeFournisseur = commandeFournisseurRepository
				.findById(detailCommandeFournisseurDto.getUuidCommandeFournisseur()).orElseThrow(null);
